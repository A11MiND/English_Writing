...
async def test_personal_practice_history_and_result_keep_submission_and_ai_feedback_together() -> None:
    ...
    marking = MarkingResult(
        ...
        status="AI_MARKED",
        dimension_scores=[
            {"name": "Content", "score": 4, "max_score": 5, "feedback": "The story stays focused."},
            {"name": "Language", "score": 4, "max_score": 5, "feedback": "Most sentences are clear."},
            {"name": "Organisation", "score": 5, "max_score": 5, "feedback": "The events follow a clear order."},
        ],
        total_score=13,
