...
class TestOpenAuthAdapter(OpenAuthAdapter):
    ...
    subjects = {
        "system@school.example": OpenAuthSubject(
            "22222222-2222-4222-8222-222222222222", None, Role.SYSTEM_ADMIN
        ),
        "admin@school.example": OpenAuthSubject(
            "33333333-3333-4333-8333-333333333333",
            "11111111-1111-4111-8111-111111111111",
            Role.SCHOOL_ADMIN,
        ),
        "teacher@school.example": OpenAuthSubject(
            "44444444-4444-4444-8444-444444444444",
            "11111111-1111-4111-8111-111111111111",
            Role.TEACHER,
        ),
        "other.teacher@school.example": OpenAuthSubject(
            "44444444-4444-4444-8444-444444444445",
            "11111111-1111-4111-8111-111111111111",
            Role.TEACHER,
        ),
        "student@school.example": OpenAuthSubject(
            "55555555-5555-4555-8555-555555555555",
            "11111111-1111-4111-8111-111111111111",
            Role.STUDENT,
        ),
        "other.student@school.example": OpenAuthSubject(
            "55555555-5555-4555-8555-555555555556",
            "11111111-1111-4111-8111-111111111111",
            Role.STUDENT,
        ),
        "suspended@school.example": OpenAuthSubject(
            "66666666-6666-4666-8666-666666666666",
            "11111111-1111-4111-8111-111111111111",
            Role.STUDENT,
        ),
        "archived@school.example": OpenAuthSubject(
