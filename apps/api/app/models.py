...
class MarkingResult(Base):
    ...
    organisation_score: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ...
    language_feedback: Mapped[str | None] = mapped_column(Text, nullable=True)
    organisation_feedback: Mapped[str | None] = mapped_column(Text, nullable=True)
