...
class ErrorCode(str):
    ...
    WORD_COUNT_BELOW_MINIMUM = "WORD_COUNT_BELOW_MINIMUM"
    WORD_COUNT_ABOVE_MAXIMUM = "WORD_COUNT_ABOVE_MAXIMUM"
    SUBMISSION_DEADLINE_PASSED = "SUBMISSION_DEADLINE_PASSED"
    SUBMISSION_TRIGGER_NOT_ALLOWED = "SUBMISSION_TRIGGER_NOT_ALLOWED"
