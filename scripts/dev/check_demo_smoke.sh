...
ADMIN_EMAIL="${ADMIN_EMAIL:-admin@wfjosephlee.edu.hk}"
TEACHER_EMAIL="${TEACHER_EMAIL:-teacher@wfjosephlee.edu.hk}"
STUDENT_EMAIL="${STUDENT_EMAIL:-student@wfjosephlee.edu.hk}"
